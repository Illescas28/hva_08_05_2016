...
<?php
    ...
    for($i=3;$i<591;$i++){
      ...
      //  $enero = trim($allDataInSheet[$i]["AF"]);
        ...
        $junio = trim($allDataInSheet[$i]["G"]);
        $julio = trim($allDataInSheet[$i]["H"]);
        $ago = trim($allDataInSheet[$i]["I"]);
        $sept = trim($allDataInSheet[$i]["J"]);
        $oct = trim($allDataInSheet[$i]["K"]);
        $nov = trim($allDataInSheet[$i]["L"]);
