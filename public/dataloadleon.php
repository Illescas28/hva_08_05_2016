...
<?php
    ...
    for($i=4;$i<1558;$i++){
        ...
        $enero1 = trim($allDataInSheet[$i]["G"]);
        $feb1 = trim($allDataInSheet[$i]["H"]);
        $mar1 = trim($allDataInSheet[$i]["I"]);
        $abr1 = trim($allDataInSheet[$i]["J"]);
        $mayo1 = trim($allDataInSheet[$i]["K"]);
        $junio1 = trim($allDataInSheet[$i]["L"]);
        $julio1 = trim($allDataInSheet[$i]["M"]);
        $ago1 = trim($allDataInSheet[$i]["N"]);
        $sept1 = trim($allDataInSheet[$i]["O"]);
        $oct1 = trim($allDataInSheet[$i]["P"]);
        $nov1 = trim($allDataInSheet[$i]["Q"]);
        $dic1 = trim($allDataInSheet[$i]["R"]);

        
        $enero = trim($allDataInSheet[$i]["S"]);
        $feb = trim($allDataInSheet[$i]["T"]);
        $mar = trim($allDataInSheet[$i]["U"]);
        $abr = trim($allDataInSheet[$i]["V"]);
        $mayo = trim($allDataInSheet[$i]["W"]);
        $junio = trim($allDataInSheet[$i]["X"]);
        $julio = trim($allDataInSheet[$i]["Y"]);
        $ago = trim($allDataInSheet[$i]["Z"]);
        $sept = trim($allDataInSheet[$i]["AA"]);
        $oct = trim($allDataInSheet[$i]["AB"]);
       $nov = trim($allDataInSheet[$i]["AC"]);
