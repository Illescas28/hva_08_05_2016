...
namespace Notasremision\PdfGenerator;

use Notasremision\PdfGenerator\FPDF\FPDF;
...
class PdfGenerator extends FPDF {
    ...
    public function FancyTable() {
       ...
       setlocale(LC_MONETARY, 'en_US');
        foreach ($this->order['detalles'] as $row) {
            
            if(isset($row['cargoadmision_cantidad'])){
                $this->Cell(20, 6, (int)$row['cargoadmision_cantidad'], 'LR', 0, 'L', $fill);
            }elseif(isset($row['cantidad'])){
                $this->Cell(20, 6, (int)$row['cantidad'], 'LR', 0, 'L', $fill);
            }
            
            if(isset($row['servicio_unidad'])){
                $this->Cell(20, 6, $row['servicio_unidad'], 'LR', 0, 'L', $fill);
            }elseif(isset($row['articulo_unidad'])){
                $this->Cell(20, 6, $row['articulo_unidad'], 'LR', 0, 'L', $fill);
            }
            
            if(isset($row['servicio_nombre'])){
                $this->Cell(80, 6, $row['servicio_nombre'], 'L', 0, 'L', $fill);
            }elseif(isset($row['articulo_nombre'])){
                $this->Cell(80, 6, $row['articulo_nombre'], 'L', 0, 'L', $fill);
            } 
            
            if(isset($row['servicio_valorunitario'])){
                //$this->Cell(40, 6, money_format('%(#5n',$row['servicio_valorunitario']), 'LR', 0, 'R', $fill);
                $this->Cell(40, 6, number_format( $row['servicio_valorunitario'], 2), 'LR', 0, 'R', $fill);
            }elseif(isset($row['articulo_valorunitario'])){
                //$this->Cell(40, 6, money_format('%(#5n',$row['articulo_valorunitario']), 'LR', 0, 'R', $fill);
                $this->Cell(40, 6, number_format( $row['articulo_valorunitario'], 2), 'LR', 0, 'R', $fill);
            } 
            
            if(isset($row['cargoadmision_monto'])){
                //$this->Cell(30, 6, money_format('%(#5n',$row['cargoadmision_monto']), 'LR', 0, 'R', $fill);
                $this->Cell(30, 6, number_format($row['articulo_valorunitario'], 2), 'LR', 0, 'R', $fill);
            }elseif(isset($row['monto'])){
                //$this->Cell(30, 6, money_format('%(#5n',$row['monto']), 'LR', 0, 'R', $fill);
                $this->Cell(30, 6, number_format( $row['monto'], 2), 'LR', 0, 'R', $fill);
            }
        ...
        if(isset($this->order['admision_total'])){
           // $this->Cell(30, 6, money_format('%(#5n',$this->order['admision_total']), 'LR', 0, 'R', $fill);
            $this->Cell(30, 6, number_format( $this->order['admision_total'], 2), 'LR', 0, 'R', $fill);
        }elseif(isset($this->order['consulta_total'])){
           // $this->Cell(30, 6, money_format('%(#5n',$this->order['consulta_total']), 'LR', 0, 'R', $fill);
            $this->Cell(30, 6, number_format( $this->order['consulta_total'], 2), 'LR', 0, 'R', $fill);
        }elseif(isset($this->order['venta_total'])){
            //$this->Cell(30, 6, money_format('%(#5n',$this->order['venta_total']), 'LR', 0, 'R', $fill);
            $this->Cell(30, 6, number_format( $this->order['venta_total'], 2), 'LR', 0, 'R', $fill);
        }
