...
namespace Facturacion\PdfGenerator;

use Facturacion\PdfGenerator\FPDF\FPDF;
...
class PdfGenerator extends FPDF {
    ...
    public function __construct($cfdi,$cadena_original,$qrcode) {
    ...
    public function FancyTable() {
       ...
       setlocale(LC_MONETARY, 'en_US');
        foreach ($this->cfdi['Conceptos'] as $row) {
            ...
            $this->Cell(40, 6, number_format( $row['valorUnitario'], 2), 'LR', 0, 'R', $fill);
           // $this->Cell(30, 6, money_format('%(#5n',$row['importe']), 'LR', 0, 'R', $fill);
            $this->Cell(30, 6, number_format( $row['importe'], 2), 'LR', 0, 'R', $fill);
            $this->Ln();
            //$fill = !$fill;
        }
        ...
        $this->Cell(30, 6, number_format( $this->cfdi['Comprobante']['subTotal']), 'LR', 0, 'R', $fill);
        $this->Ln();
        //IVA(TRASLADOS)
        $this->Cell(20, 6, '', 'LR', 0, 'L', $fill);
        $this->Cell(20, 6, '', 'LR', 0, 'L', $fill);
        ...
        $this->Cell(30, 6, number_format( $this->cfdi['totalImpuestosTrasladados']), 'LR', 0, 'R', $fill);
       ...
       // $this->Cell(30, 6, money_format('%(#5n',$this->cfdi['Comprobante']['total']), 'LR', 0, 'R', $fill);
         $this->Cell(30, 6, number_format( $this->cfdi['Comprobante']['total']), 'LR', 0, 'R', $fill);
        $this->Ln(10);
