...
namespace Catalogos\Servicio\Controller;

use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;

//// Form ////
use Catalogos\Servicio\Form\ServicioForm;

//// Filter ////
use Catalogos\Servicio\Filter\ServicioFilter;
...
class ServicioController extends AbstractActionController
{
    ...
    {
        // Instanciamos nuestro formulario servicioForm
        $servicioForm = new ServicioForm();
        ...
        if (!$id) {
            ...
            if ($request->isPost()) { //Si hicieron POST
                ...
                if($servicioForm->isValid()){
                    ...
                    //Agregamos un mensaje
                    $this->flashMessenger()->addMessage('Servicio guardada exitosamente!');
