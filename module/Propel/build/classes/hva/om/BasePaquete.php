...
/**
 * Base class that represents a row from the 'paquete' table.
 *
 *
 *
...
abstract class BasePaquete extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the paquete_nombre field.
     * @var        string
     */
    protected $paquete_nombre;

    /**
     * The value for the paquete_descripcion field.
     * @var        string
     */
    protected $paquete_descripcion;
    ...
    /**
     * Get the [paquete_nombre] column value.
     *
     * @return string
     */
    public function getPaqueteNombre()
    {
        ...
        return $this->paquete_nombre;
    }

    /**
     * Get the [paquete_descripcion] column value.
     *
     * @return string
     */
     ...
     * @return Paquete The current object (for fluent API support)
     */
    public function setIdpaquete($v)
    {
        ...
        if ($this->idpaquete !== $v) {
            $this->idpaquete = $v;
            $this->modifiedColumns[] = PaquetePeer::IDPAQUETE;
        }
    ...
    /**
     * Set the value of [paquete_nombre] column.
     *
     * @param  string $v new value
     * @return Paquete The current object (for fluent API support)
     */
    public function setPaqueteNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->paquete_nombre !== $v) {
            $this->paquete_nombre = $v;
            $this->modifiedColumns[] = PaquetePeer::PAQUETE_NOMBRE;
        }
    ...
    /**
     * Set the value of [paquete_descripcion] column.
     *
     * @param  string $v new value
     * @return Paquete The current object (for fluent API support)
     */
    public function setPaqueteDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->paquete_descripcion !== $v) {
            $this->paquete_descripcion = $v;
            $this->modifiedColumns[] = PaquetePeer::PAQUETE_DESCRIPCION;
        }


        return $this;
    } // setPaqueteDescripcion()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idpaquete = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->paquete_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->paquete_descripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = PaquetePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PaquetePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PaqueteQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PaquetePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = PaquetePeer::IDPAQUETE;
        if (null !== $this->idpaquete) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . PaquetePeer::IDPAQUETE . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(PaquetePeer::IDPAQUETE)) {
            $modifiedColumns[':p' . $index++]  = '`idpaquete`';
        }
        if ($this->isColumnModified(PaquetePeer::PAQUETE_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`paquete_nombre`';
        }
        if ($this->isColumnModified(PaquetePeer::PAQUETE_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`paquete_descripcion`';
        }

        $sql = sprintf(
            'INSERT INTO `paquete` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idpaquete`':
                        ...
                        break;
                    case '`paquete_nombre`':
                        $stmt->bindValue($identifier, $this->paquete_nombre, PDO::PARAM_STR);
                        break;
                    case '`paquete_descripcion`':
                        $stmt->bindValue($identifier, $this->paquete_descripcion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getPaqueteNombre();
                break;
            case 2:
                return $this->getPaqueteDescripcion();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Paquete'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Paquete'][$this->getPrimaryKey()] = true;
        $keys = PaquetePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdpaquete(),
            $keys[1] => $this->getPaqueteNombre(),
            $keys[2] => $this->getPaqueteDescripcion(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setPaqueteNombre($value);
                break;
            case 2:
                $this->setPaqueteDescripcion($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPaqueteNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setPaqueteDescripcion($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaquetePeer::IDPAQUETE)) $criteria->add(PaquetePeer::IDPAQUETE, $this->idpaquete);
        if ($this->isColumnModified(PaquetePeer::PAQUETE_NOMBRE)) $criteria->add(PaquetePeer::PAQUETE_NOMBRE, $this->paquete_nombre);
        if ($this->isColumnModified(PaquetePeer::PAQUETE_DESCRIPCION)) $criteria->add(PaquetePeer::PAQUETE_DESCRIPCION, $this->paquete_descripcion);
    ...
    {
        $criteria = new Criteria(PaquetePeer::DATABASE_NAME);
        $criteria->add(PaquetePeer::IDPAQUETE, $this->idpaquete);
    ...
    /**
     * Generic method to set the primary key (idpaquete column).
     *
     ...
     * objects.
     *
     * @param object $copyObj An object of Paquete (or compatible) type.
    ...
    {
        $copyObj->setPaqueteNombre($this->getPaqueteNombre());
        $copyObj->setPaqueteDescripcion($this->getPaqueteDescripcion());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdpaquete(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Paquete Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Paquete is new, it will return
    ...
    public function setPaquetedetalles(PropelCollection $paquetedetalles, PropelPDO $con = null)
    {
        ...
        foreach ($paquetedetallesToDelete as $paquetedetalleRemoved) {
            $paquetedetalleRemoved->setPaquete(null);
        }
    ...
    protected function doAddPaquetedetalle($paquetedetalle)
    {
        ...
        $paquetedetalle->setPaquete($this);
    }
    ...
    public function removePaquetedetalle($paquetedetalle)
    {
        if ($this->getPaquetedetalles()->contains($paquetedetalle)) {
            ...
            $this->paquetedetallesScheduledForDeletion[]= clone $paquetedetalle;
            $paquetedetalle->setPaquete(null);
        }
     ...
     * Otherwise if this Paquete is new, it will return
     * an empty collection; or if this Paquete has previously
     * been saved, it will retrieve related Paquetedetalles from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Paquete.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Paquetedetalle[] List of Paquetedetalle objects
     */
    public function getPaquetedetallesJoinArticulo($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PaquetedetalleQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(PaquetePeer::DEFAULT_STRING_FORMAT);
    }
