...
abstract class BaseGastoPeer
{
    ...
    /** the column name for the gasto_nombre field */
    const GASTO_NOMBRE = 'gasto.gasto_nombre';

    /** the column name for the gasto_descripcion field */
    const GASTO_DESCRIPCION = 'gasto.gasto_descripcion';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of Gasto objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idgasto', 'GastoNombre', 'GastoDescripcion', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idgasto', 'gastoNombre', 'gastoDescripcion', ),
        BasePeer::TYPE_COLNAME => array (GastoPeer::IDGASTO, GastoPeer::GASTO_NOMBRE, GastoPeer::GASTO_DESCRIPCION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDGASTO', 'GASTO_NOMBRE', 'GASTO_DESCRIPCION', ),
        BasePeer::TYPE_FIELDNAME => array ('idgasto', 'gasto_nombre', 'gasto_descripcion', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idgasto' => 0, 'GastoNombre' => 1, 'GastoDescripcion' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idgasto' => 0, 'gastoNombre' => 1, 'gastoDescripcion' => 2, ),
        BasePeer::TYPE_COLNAME => array (GastoPeer::IDGASTO => 0, GastoPeer::GASTO_NOMBRE => 1, GastoPeer::GASTO_DESCRIPCION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDGASTO' => 0, 'GASTO_NOMBRE' => 1, 'GASTO_DESCRIPCION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idgasto' => 0, 'gasto_nombre' => 1, 'gasto_descripcion' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(GastoPeer::IDGASTO);
            $criteria->addSelectColumn(GastoPeer::GASTO_NOMBRE);
            $criteria->addSelectColumn(GastoPeer::GASTO_DESCRIPCION);
        } else {
            $criteria->addSelectColumn($alias . '.idgasto');
            $criteria->addSelectColumn($alias . '.gasto_nombre');
            $criteria->addSelectColumn($alias . '.gasto_descripcion');
        }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(GastoPeer::IDGASTO) && $criteria->keyContainsValue(GastoPeer::IDGASTO) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(GastoPeer::IDGASTO);
            $value = $criteria->remove(GastoPeer::IDGASTO);
            if ($value) {
                $selectCriteria->add(GastoPeer::IDGASTO, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += GastoPeer::doOnDeleteCascade(new Criteria(GastoPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(GastoPeer::IDGASTO, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += GastoPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = GastoPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {
            ...
            $criteria->add(CajachicadetallePeer::IDGASTO, $obj->getIdgasto());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(GastoPeer::DATABASE_NAME);
        $criteria->add(GastoPeer::IDGASTO, $pk);
    ...
    public static function retrieveByPKs($pks, PropelPDO $con = null)
    {
        ...
        if (empty($pks)) {
            ...
            $criteria = new Criteria(GastoPeer::DATABASE_NAME);
            $criteria->add(GastoPeer::IDGASTO, $pks, Criteria::IN);
