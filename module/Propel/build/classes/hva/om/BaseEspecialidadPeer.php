...
/**
 * Base static class for performing query and update operations on the 'especialidad' table.
 *
 *
 *
...
abstract class BaseEspecialidadPeer
{
    ...
    const IDESPECIALIDAD = 'especialidad.idespecialidad';

    /** the column name for the especialidad_nombre field */
    const ESPECIALIDAD_NOMBRE = 'especialidad.especialidad_nombre';

    /** the column name for the especialidad_descripcion field */
    const ESPECIALIDAD_DESCRIPCION = 'especialidad.especialidad_descripcion';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Idespecialidad', 'EspecialidadNombre', 'EspecialidadDescripcion', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idespecialidad', 'especialidadNombre', 'especialidadDescripcion', ),
        BasePeer::TYPE_COLNAME => array (EspecialidadPeer::IDESPECIALIDAD, EspecialidadPeer::ESPECIALIDAD_NOMBRE, EspecialidadPeer::ESPECIALIDAD_DESCRIPCION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDESPECIALIDAD', 'ESPECIALIDAD_NOMBRE', 'ESPECIALIDAD_DESCRIPCION', ),
        BasePeer::TYPE_FIELDNAME => array ('idespecialidad', 'especialidad_nombre', 'especialidad_descripcion', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Idespecialidad' => 0, 'EspecialidadNombre' => 1, 'EspecialidadDescripcion' => 2, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('idespecialidad' => 0, 'especialidadNombre' => 1, 'especialidadDescripcion' => 2, ),
        BasePeer::TYPE_COLNAME => array (EspecialidadPeer::IDESPECIALIDAD => 0, EspecialidadPeer::ESPECIALIDAD_NOMBRE => 1, EspecialidadPeer::ESPECIALIDAD_DESCRIPCION => 2, ),
        BasePeer::TYPE_RAW_COLNAME => array ('IDESPECIALIDAD' => 0, 'ESPECIALIDAD_NOMBRE' => 1, 'ESPECIALIDAD_DESCRIPCION' => 2, ),
        BasePeer::TYPE_FIELDNAME => array ('idespecialidad' => 0, 'especialidad_nombre' => 1, 'especialidad_descripcion' => 2, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(EspecialidadPeer::IDESPECIALIDAD);
            $criteria->addSelectColumn(EspecialidadPeer::ESPECIALIDAD_NOMBRE);
            $criteria->addSelectColumn(EspecialidadPeer::ESPECIALIDAD_DESCRIPCION);
        } else {
            $criteria->addSelectColumn($alias . '.idespecialidad');
            $criteria->addSelectColumn($alias . '.especialidad_nombre');
            $criteria->addSelectColumn($alias . '.especialidad_descripcion');
        }
    }
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof Especialidad) {
                $key = (string) $value->getIdespecialidad();
    ...
    {
        // Invalidate objects in MedicoPeer instance pool,
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(EspecialidadPeer::IDESPECIALIDAD) && $criteria->keyContainsValue(EspecialidadPeer::IDESPECIALIDAD) ) {
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(EspecialidadPeer::IDESPECIALIDAD);
            $value = $criteria->remove(EspecialidadPeer::IDESPECIALIDAD);
            if ($value) {
                $selectCriteria->add(EspecialidadPeer::IDESPECIALIDAD, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += EspecialidadPeer::doOnDeleteCascade(new Criteria(EspecialidadPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(EspecialidadPeer::IDESPECIALIDAD, (array) $values, Criteria::IN);
        }
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += EspecialidadPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related Medico objects
            $criteria = new Criteria(MedicoPeer::DATABASE_NAME);

            $criteria->add(MedicoPeer::IDESPECIALIDAD, $obj->getIdespecialidad());
            $affectedRows += MedicoPeer::doDelete($criteria, $con);

            // delete related Medicoespecialidad objects
            $criteria = new Criteria(MedicoespecialidadPeer::DATABASE_NAME);

            $criteria->add(MedicoespecialidadPeer::IDESPECIALIDAD, $obj->getIdespecialidad());
    ...
    public static function retrieveByPK($pk, PropelPDO $con = null)
    {
        ...
        $criteria = new Criteria(EspecialidadPeer::DATABASE_NAME);
        $criteria->add(EspecialidadPeer::IDESPECIALIDAD, $pk);
