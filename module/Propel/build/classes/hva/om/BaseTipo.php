...
abstract class BaseTipo extends BaseObject implements Persistent
{
     ...
     * Otherwise if this Tipo is new, it will return
     * an empty collection; or if this Tipo has previously
     * been saved, it will retrieve related Articulos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Tipo.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Articulo[] List of Articulo objects
     */
    public function getArticulosJoinUdm($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ArticuloQuery::create(null, $criteria);
        $query->joinWith('Udm', $join_behavior);
