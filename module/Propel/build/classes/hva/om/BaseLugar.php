...
abstract class BaseLugar extends BaseObject implements Persistent
{
     ...
     * Otherwise if this Lugar is new, it will return
     * an empty collection; or if this Lugar has previously
     * been saved, it will retrieve related TraspasosRelatedByIdlugardestinatario from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Lugar.
     ...
     * @return PropelObjectCollection|Traspaso[] List of Traspaso objects
     */
    public function getTraspasosRelatedByIdlugardestinatarioJoinOrdencompra($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TraspasoQuery::create(null, $criteria);
        $query->joinWith('Ordencompra', $join_behavior);

        return $this->getTraspasosRelatedByIdlugardestinatario($query, $con);
    }
     ...
     * Otherwise if this Lugar is new, it will return
     * an empty collection; or if this Lugar has previously
     * been saved, it will retrieve related TraspasosRelatedByIdlugarremitente from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Lugar.
     ...
     * @return PropelObjectCollection|Traspaso[] List of Traspaso objects
     */
    public function getTraspasosRelatedByIdlugarremitenteJoinOrdencompra($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = TraspasoQuery::create(null, $criteria);
        $query->joinWith('Ordencompra', $join_behavior);

        return $this->getTraspasosRelatedByIdlugarremitente($query, $con);
    }
