...
abstract class BaseModulo extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the modulo_nombre field.
     * @var        string
     */
    protected $modulo_nombre;

    /**
     * The value for the modulo_descripcion field.
     * @var        string
     */
    ...
    /**
     * Get the [modulo_nombre] column value.
     *
     * @return string
     */
    ...
    /**
     * Get the [modulo_descripcion] column value.
     *
     * @return string
     */
    ...
    public function setIdmodulo($v)
    {
        ...
        if ($this->idmodulo !== $v) {
            $this->idmodulo = $v;
            $this->modifiedColumns[] = ModuloPeer::IDMODULO;
        }
    ...
    /**
     * Set the value of [modulo_nombre] column.
     *
     * @param  string $v new value
     * @return Modulo The current object (for fluent API support)
     */
    public function setModuloNombre($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->modulo_nombre !== $v) {
            $this->modulo_nombre = $v;
            $this->modifiedColumns[] = ModuloPeer::MODULO_NOMBRE;
        }
    ...
    /**
     * Set the value of [modulo_descripcion] column.
     *
     * @param  string $v new value
     * @return Modulo The current object (for fluent API support)
     */
    public function setModuloDescripcion($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->modulo_descripcion !== $v) {
            $this->modulo_descripcion = $v;
            $this->modifiedColumns[] = ModuloPeer::MODULO_DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idmodulo = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->modulo_nombre = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->modulo_descripcion = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ModuloPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ModuloPeer::IDMODULO;
        if (null !== $this->idmodulo) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . ModuloPeer::IDMODULO . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(ModuloPeer::IDMODULO)) {
            $modifiedColumns[':p' . $index++]  = '`idmodulo`';
        }
        if ($this->isColumnModified(ModuloPeer::MODULO_NOMBRE)) {
            $modifiedColumns[':p' . $index++]  = '`modulo_nombre`';
        }
        if ($this->isColumnModified(ModuloPeer::MODULO_DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`modulo_descripcion`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idmodulo`':
                        ...
                        break;
                    case '`modulo_nombre`':
                        $stmt->bindValue($identifier, $this->modulo_nombre, PDO::PARAM_STR);
                        break;
                    case '`modulo_descripcion`':
                        $stmt->bindValue($identifier, $this->modulo_descripcion, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getModuloNombre();
                break;
            case 2:
                return $this->getModuloDescripcion();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[1] => $this->getModuloNombre(),
            $keys[2] => $this->getModuloDescripcion(),
        );
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                $this->setModuloNombre($value);
                break;
            case 2:
                $this->setModuloDescripcion($value);
                break;
        } // switch()
    }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdmodulo($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setModuloNombre($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setModuloDescripcion($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ModuloPeer::IDMODULO)) $criteria->add(ModuloPeer::IDMODULO, $this->idmodulo);
        if ($this->isColumnModified(ModuloPeer::MODULO_NOMBRE)) $criteria->add(ModuloPeer::MODULO_NOMBRE, $this->modulo_nombre);
        if ($this->isColumnModified(ModuloPeer::MODULO_DESCRIPCION)) $criteria->add(ModuloPeer::MODULO_DESCRIPCION, $this->modulo_descripcion);
    ...
    {
        $criteria = new Criteria(ModuloPeer::DATABASE_NAME);
        $criteria->add(ModuloPeer::IDMODULO, $this->idmodulo);
    ...
    /**
     * Generic method to set the primary key (idmodulo column).
     *
    ...
    {
        $copyObj->setModuloNombre($this->getModuloNombre());
        $copyObj->setModuloDescripcion($this->getModuloDescripcion());
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdmodulo(NULL); // this is a auto-increment column, so set to default value
        }
    }
