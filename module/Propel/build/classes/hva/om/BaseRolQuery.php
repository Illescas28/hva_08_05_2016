 ...
 *
 * @method RolQuery leftJoinRolmodulo($relationAlias = null) Adds a LEFT JOIN clause to the query using the Rolmodulo relation
 * @method RolQuery rightJoinRolmodulo($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Rolmodulo relation
 * @method RolQuery innerJoinRolmodulo($relationAlias = null) Adds a INNER JOIN clause to the query using the Rolmodulo relation
 *
...
abstract class BaseRolQuery extends ModelCriteria
{
    ...
    public function filterByRolmodulo($rolmodulo, $comparison = null)
    {
        if ($rolmodulo instanceof Rolmodulo) {
            return $this
                ->addUsingAlias(RolPeer::IDROL, $rolmodulo->getIdrol(), $comparison);
